...
augroup transparent
    ...
    command -bar -nargs=0 TransparentEnable lua require('transparent').toggle_transparent(1)
    command -bar -nargs=0 TransparentDisable lua require('transparent').toggle_transparent(0)
